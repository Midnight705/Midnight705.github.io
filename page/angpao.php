    ...
    <div class="container-sm  ps-4 pe-4">
        <div class="container-fluid bg-white p-4">
            <div class="col-lg-7 m-auto">
                <h1 class="text-strongest text-main" data-aos="fade-right" data-aos-duration="500"><i class="fa-duotone fa-coins"></i> &nbsp;TOPUP (เติมเงิน)</h1>
                <div data-aos="fade-right" data-aos-duration="600" >
                    <hr class="mt-1 mb-2">
                    <h5 class="text-black m-0"><i class="fa-regular fa-plus-circle"></i>&nbsp;ระบบเติมเงินด้วยซองของขวัญ</h5>
                </div>
                <center>
                ...
                <button class="bg-main-gra btn mt-2 text-black w-100"  id="topup_btn" style="border-radius: 20px;" data-aos="fade-up" data-aos-duration="800">ยืนยันการเติมเงิน</button>
            </div>
        </div>
